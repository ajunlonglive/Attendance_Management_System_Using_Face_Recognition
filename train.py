...
class Train:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Tải Dữ Liệu Khuôn Mặt",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\VKU\STEM\Python-FYP-Face-Recognition-Attendence-System\Images_GUI\t_btn1.png")
        ...
        std_b1_1 = Button(bg_img,command=self.train_classifier,text="Tải Dữ Liệu",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            cv2.imshow("Tải Dữ Liệu",imageNp)
            cv2.waitKey(1)==13
